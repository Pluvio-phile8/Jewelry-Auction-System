        ...
        <div class="container-fluid ">
            ...
            <section class="home-section">
                <main role="main" class="col-span-9 ml-auto col-span-10 px-4">
                    ...
                    <br>
                    <h1 class="heading-main">Manage Auction</h1>
                    ...
                    <div class="relative flex w-80 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md mb-4">
                        ...
                        <div class="p-6 pt-0">
                          <form action="${pageContext.request.contextPath}/auctions/detail.jsp" method="get">
                            ...
                            <button type="submit" class="select-none rounded-lg bg-blue-500 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
                              View Details
                            </button>
                          </form>
                        </div>
